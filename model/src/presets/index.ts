...
import genericAmpliconNoUmi from "./generic/amplicon-no-umi";
import genericAmpliconUmi from "./generic/amplicon-umi";

export type { Preset } from "./types";

export const allPresets: readonly Preset[] = [
  nebPhd7,
  nebPhd12,
  genericAmpliconNoUmi,
  genericAmpliconUmi,
] as const;
